...
local ok, my_own_tab = pcall(function()
	return shared.CreateTab("Firefly Timer", "")
end)
...
print("[Firefly Timer] Loaded successfully")	frame = Instance.new("Frame")
	frame.Name = "TimerFrame"
	frame.Size = frameSize
	frame.Position = framePosition
	frame.BackgroundTransparency = 0.7
...
print("[Firefly Timer] Loaded successfully")	label.TextScaled = true
	label.Font = Enum.Font.GothamBold
	label.Text = tostring(countdownDuration)
	label.Parent = frame
